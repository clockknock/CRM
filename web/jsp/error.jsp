				...
				<tr>
					...
					<td align="center" bgcolor="#ffffff">
						<table width="100%" height=200 border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center" style="font-size: 14px;"><img src="${pageContext.request.contextPath}/images/info.png" align="middle" height="30" width="30" />
		...
		<table cellSpacing="0" cellPadding="0" width="98%" border="0">
			<tbody>
				<tr>
					...
					<td align="middle" width="100%" background="${pageContext.request.contextPath}/images/new_025.jpg" height="15">
					</td>
					<td width="15">
