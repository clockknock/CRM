                ...
                <table cellSpacing="0" cellPadding="3" width="165" align="center" border="0">
                    ...
                    <tr>
                        <td class="mainMenu" onClick="menuDisplay('table_2');">
                            <span class="span" id="table_2Span">＋</span> 联系人管理</td>
                    </tr>
                    ...
                    <tr>
                        <td class=mainMenu onClick="menuDisplay('table_5');">
                            <span class=span id=table_5Span>＋</span> 客户拜访管理</td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table id="table_5" style="display: none" cellSpacing="0" cellPadding="2" width="155" align="center" border="0">
                                ...
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－新增客户拜访</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－客户拜访列表</a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mainMenu" onClick="menuDisplay('table_3');">
                            <span class="span" id="table_3Span">＋</span> 综合查询</td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            <table id="table_3" style="display: none" cellSpacing="0" cellPadding="2" width="155" align="center" border="0">
                                ...
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－ 客户信息查询</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－ 联系人信息查询</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="mainMenu">
                                        <a class="style2" href="#" target="main">－ 客户拜访记录查询</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td class=mainMenu onClick="menuDisplay('table_4');">
                            <span class="span" id="table_4Span">＋</span> 统计分析</td>
                    </tr>
                    <tr>
                        <td>
                            <table id="table_4" style="display: none" cellSpacing="0" cellPadding="2" width="155" align="center" border="0">
                                ...
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－客户行业统计</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－客户来源统计</a>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td class="mainMenu" onClick="menuDisplay('table_6');">
                            <span class="span" id="table_6Span">＋</span>系统管理</td>
                    </tr>
                    <tr>
                        <td>
                            <table id="table_6" style="display: none" cellspacing="0" cellpadding="2" width="155" align="center" border="0">
                                ...
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－角色管理</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－用户管理</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="menuSmall">
                                        <a class="style2" href="#" target="main">－数据字典</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
